...
export default function Post(){
    ...
    useEffect(()=>{
        sanityClient
        .fetch('*[_type=="post"] {title,slug,mainImage{asset->{id,url},alt}}')
    ...
    return(
        <main className="bg-green-400 min-h-screen p-12"> 
            <section className="container mx-auto">
                ...
                <h2 className="text-xl text-gray-600 flex justify-center mb-12">Welcome to my page of blog posts</h2>
